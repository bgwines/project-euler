...
int_to_roman_singular :: Integer -> String
int_to_roman_singular 1 = "I"
int_to_roman_singular 2 = "II"
int_to_roman_singular 3 = "III"
int_to_roman_singular 4 = "IV"
int_to_roman_singular 5 = "V"
int_to_roman_singular 6 = "VI"
int_to_roman_singular 7 = "VII"
int_to_roman_singular 8 = "VIII"
int_to_roman_singular 9 = "IX"
int_to_roman_singular 10 = "X"
int_to_roman_singular 50 = "L"
int_to_roman_singular 100 = "C"
int_to_roman_singular 500 = "D"
int_to_roman_singular 1000 = "M"

roman_to_int_singular :: String -> Integer
roman_to_int_singular "I" = 1
roman_to_int_singular "V" = 5
roman_to_int_singular "X" = 10
roman_to_int_singular "L" = 50
roman_to_int_singular "C" = 100
roman_to_int_singular "D" = 500
roman_to_int_singular "M" = 1000

roman_to_int_singular' :: String -> Integer
roman_to_int_singular' s = 
	if length s == 1 then
		roman_to_int_singular s
	else
		(length' s) * (roman_to_int_singular ([s !! 0]))
...
next ch =
	if ch == "M" then
		...
		strings !! ((from_just $ List.elemIndex ch strings) + 1)

int_to_roman :: Integer -> String
int_to_roman n
	| n == 0 = ""
	| otherwise = 
		let
			largest_less_than_n = find_guaranteed (<=n) $ reverse ints
			x = 
				if ((show largest_less_than_n) !! 0) == ("5" !! 0) then 
					largest_less_than_n `div` 5
				else
					largest_less_than_n
		in
			if n == largest_less_than_n || n < 10 then
				int_to_roman_singular n
			else
				let
					a = represent n x
					b = int_to_roman (n `mod` x)
				in
					a ++ b

represent :: Integer -> Integer -> String
represent n x = 
	let
		ch = int_to_roman_singular x
	in
		represent_wholeish ch (n `div` x)

represent_wholeish :: String -> Integer -> String
represent_wholeish ch n = 
	if ch == "M" then
		concat $ replicate (fromInteger n) ch
	else
		case n of
			1 -> ch
			2 -> ch ++ ch
